...
import chesslers from '../images/sponsors/chesslers.png';
import razespace from '../images/sponsors/Razespace.png';
import SCGC from '../images/sponsors/scgc.webp';
import VR from '../images/sponsors/VR.png';
    ...
    <div>
      {
        <div className="sponsorship">
          <div className="sponsorshipHead">
            ...
            <a href="tel:7728837630" className="teleIcon" target="_blank" rel="noopener noreferrer">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone" class="svg-inline--fa fa-phone " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"></path></svg>
              7728837630
            </a>
            <a href="mailto:2020eeb1171@iitrpr.ac.in/sponsors" className="mailIcon" target="_blank" rel="noopener noreferrer">
        ...
        <div className="sponsors">
          <div className="eventSponsor">
            ...
            <div className="sponsorsLogo">
              <div className="Logo">
                <a href="https://razespace.com/" target="_blank" rel="noopener noreferrer">
                  <img src={razespace} alt="Razespace" />
                </a>
              </div>
              <div className="Logo">
                <a href="https://chesslers.com/" target="_blank" rel="noopener noreferrer">
                  <img src={chesslers} alt="Chesslers" />
                </a>
              </div>
              <div className="Logo">
                <a href="https://zaap.bio/Scgc" target="_blank" rel="noopener noreferrer">
                  <img src={SCGC} alt="SCGC" />
                </a>
              </div>
              <div className="Logo">
                <a href="https://www.highclassvr.com/" target="_blank" rel="noopener noreferrer">
